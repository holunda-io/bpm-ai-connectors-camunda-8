...
def test_extract_single(runtime_selector, zeebe_test_client: ZeebeTestClient):
    # given
    variables = {
        "text1": "I am John",
    ...
    # then
    assert result['result'] == {'name': 'John', 'age': 20}


def test_extract_multiple(runtime_selector, zeebe_test_client: ZeebeTestClient):
    # given
    variables = {

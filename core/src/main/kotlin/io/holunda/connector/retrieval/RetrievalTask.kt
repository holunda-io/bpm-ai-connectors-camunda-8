...
data class RetrievalTask(
    ...
    val mode: String,
    val reranker: String?,
    val filter_metadata_field: String?,
    val summary_index: String?,
    ...
    companion object {
        fun fromRequest(request: RetrievalRequest) =
            RetrievalTask(
                ...
                request.query.mode,
                request.advanced.reranker.ifBlank { null },
                request.advanced.filterMetadataField,
                request.advanced.summaryIndex,
